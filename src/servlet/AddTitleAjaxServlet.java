 ...
 * @author yuu
 */
@WebServlet(name = "AddTitleAjaxServlet", urlPatterns = {"/AddTitleAjaxServlet"})
public class AddTitleAjaxServlet extends HttpServlet {
     ...
     * methods.
     *
     * Add title object and return the result state to ajax
     *
     * Request parameters:
     *              + titleName
     *              + titlePer
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (titleName != null && !titleName.isEmpty() && titlePer != null && !titlePer.isEmpty()) {

                TitleDTO dto = TitleDTO.getTitleDTO(titleName, titlePer);

                int addedID = addTitle(dto);
    ...
    private int addTitle(TitleDTO dto) throws SQLException, NamingException {
        TitleDAO dao = new TitleDAO();
        return dao.addTitle(dto);
    }
}
