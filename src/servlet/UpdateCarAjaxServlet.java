 ...
 * @author Yuu
 */
@WebServlet(name = "UpdateCarAjaxServlet", urlPatterns = {"/UpdateCarAjaxServlet"})
public class UpdateCarAjaxServlet extends HttpServlet {
     ...
     * methods.
     *
     * Update car object and return the result state to ajax
     *
     * Request parameters:
     *              + carID
     *              + carPlate
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (carPlate != null && !carPlate.isEmpty() && carBrand != null && !carBrand.isEmpty()
                    && carID != null && !carID.isEmpty() && carSlot != null && !carSlot.isEmpty()) {

                CarDTO dto = CarDTO.getCarDTO(carPlate, carBrand, carSlot);
                dto.setCarID(Integer.parseInt(carID));

                state = updateCar(dto) ? DONE : ERROR_SYSTEM;
    ...
    private boolean updateCar(CarDTO dto) throws SQLException, NamingException {
