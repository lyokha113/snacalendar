 ...
 * @author Yuu
 */
@WebServlet(name = "UpdateEventTrainingAjaxServlet", urlPatterns = {"/UpdateEventTrainingAjaxServlet"})
public class UpdateEventTrainingAjaxServlet extends HttpServlet {

    private final static int EVENT_TYPE = EventTypeEnum.TRAINING.getEventTypeID();
