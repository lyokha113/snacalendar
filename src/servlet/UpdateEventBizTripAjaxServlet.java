 ...
 * @author Yuu
 */
@WebServlet(name = "UpdateEventBizTripAjaxServlet", urlPatterns = {"/UpdateEventBizTripAjaxServlet"})
public class UpdateEventBizTripAjaxServlet extends HttpServlet {

    private final static int EVENT_TYPE = EventTypeEnum.BIZ_TRIP.getEventTypeID();
