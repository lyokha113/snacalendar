 ...
 * @author Yuu
 */
@WebServlet(name = "GetCarListServlet", urlPatterns = {"/GetCarListServlet"})
public class GetCarListServlet extends HttpServlet {

    private final static String PAGE = "carlist.jsp";
     ...
     * methods.
     *
     * Get list car then forward to page.
     *
     * Page forward:
     *         + carlist.jsp
     *         + 500.html (error page)
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<CarDTO> carList = getCarList();
