 ...
 * @author yuu
 */
@WebServlet(name = "GetCustomerListServlet", urlPatterns = {"/GetCustomerListServlet"})
public class GetCustomerListServlet extends HttpServlet {

    private final static String PAGE = "customerlist.jsp";
     ...
     * methods.
     *
     * Get list customer then forward to page.
     *
     * Page forward:
     *         + customerlist.jsp
     *         + 500.html (error page)
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<CustomerDTO> cusList = getCustomerList();
