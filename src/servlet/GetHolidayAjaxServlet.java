 ...
 * @author Yuu
 */
@WebServlet(name = "GetHolidayAjaxServlet", urlPatterns = {"/GetHolidayAjaxServlet"})
public class GetHolidayAjaxServlet extends HttpServlet {

    /**
     * Processes requests for both HTTP <code>GET</code> and <code>POST</code>
     * methods.
     *
     * Get list holiday and return json object array
     *
     * Respone return json object:
     *              + new HolidayDTO list as Json object array
    ...
    protected void processRequest(HttpServletResponse response)
        ...
        try {
            ...
            result = om.writerWithDefaultPrettyPrinter().writeValueAsString(holidays);
