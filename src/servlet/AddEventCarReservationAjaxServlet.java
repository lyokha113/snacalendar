 ...
 * @author Yuu
 */
@WebServlet(name = "AddEventCarReservationAjaxServlet", urlPatterns = {"/AddEventCarReservationAjaxServlet"})
public class AddEventCarReservationAjaxServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (eventTitle != null && !eventTitle.isEmpty() && eventDate != null && !eventDate.isEmpty()
                    ...
                    && eventCar != null && !eventCar.isEmpty()) {
                ...
                eventType.setEventTypeID(EventTypeEnum.CAR_RESERVATION.getEventTypeID());
                ...
                result = addEventCar(event, Integer.parseInt(eventCar)) > 0 ?
