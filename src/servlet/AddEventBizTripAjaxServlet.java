 ...
 * @author Yuu
 */
@WebServlet(name = "AddEventBizTripAjaxServlet", urlPatterns = {"/AddEventBizTripAjaxServlet"})
public class AddEventBizTripAjaxServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (eventTitle != null && !eventTitle.isEmpty() && eventDate != null && !eventDate.isEmpty()) {
                ...
                eventType.setEventTypeID(EventTypeEnum.BIZ_TRIP.getEventTypeID());
