...
<div class="calendar-header col-md-12 col-sm-12 col-xs-12">
    <div class="col-md-5 col-sm-12 col-xs-12" id="totaldays">
        <div></div>
        <div></div>
        <span>
            <span style="font-weight: bold; font-size: 14px">Status: </span>
            <span style="color: #e3bc08; font-size: 14px">Approving&emsp;</span>
            <span style="color: #006400; font-size: 14px">Approved&emsp;</span>
            <span style="color: #ad2121; font-size: 14px">Denied</span>
        </span>
    </div>
                    ...
                    <div id="event-details-body">
                        ...
                        <div class="form-group">
                            <div class="col-md-12 col-sm-12 col-xs-12 group-line">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="eventContent">Reason
                                </label>
                                <div class="col-md-10 col-sm-10 col-xs-12">
                                    <input type="text" id="eventContent" name="eventContent"
